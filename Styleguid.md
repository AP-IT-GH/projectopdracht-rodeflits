...
**Background-color:**
1. Normale kleur: `#EAF6FB`
2. Lichtere kleur: `#F0F8FA`
3. Donkerdere kleur: `#DCF3FC`

- **Text-color:**
1. Donkere kleur: `#000000` (In het geval dat de achtergrond licht is)
2. Lichte kleur: `#FFFFFF` (In het geval dat de achtergrond donker is)

- **Primary-color:**
1. Normale kleur: `#4299E1`
2. Lichtere kleur: `#67ADE7`
3. Donkerdere kleur: `#3B89CA`

- **Secondary-color:**
1. Normale kleur: `#2378DC`
2. Lichtere kleur: `#5697E4`
3. Donkerdere kleur: `#206FCB`

## Lettertype
Ik heb gekozen voor Arial, omdat Arial een sans-serif lettertype is, wat betekend dat het goed leesbaar is en hiernaast lijkt het modern wat past bij mijn thema.